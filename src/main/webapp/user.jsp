							...
							<div class="validation-grids validation-grids-right login-form">
								<div class="widget-shadow login-form-shadow"
									...
									<div class="form-body form-body-info">
										<form data-toggle="validator" action="/user/login.action"
											method="post">
											...
											<div class="form-group">
												<input type="password" data-toggle="validator"
													data-minlength="6" class="form-control" id="inputPassword1"
										...
										<form data-toggle="validator" action="#" method="post">
											...
											<div class="form-group has-feedback">
												...
												<span class="glyphicon form-control-feedback"
													...
													class="help-block with-errors">Please enter a valid
													email address</span>
											</div>
											<div class="form-group">
												<input type="password" data-toggle="validator"
													...
													name="password" placeholder="Password" required="">
												<span class="glyphicon form-control-feedback"
													aria-hidden="true"></span> <span class="help-block">Minimum
